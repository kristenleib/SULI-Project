...
void final_lpair_signal_v2(){
    ...
    // Canvas 3: Invariant Mass Distribution and Gaussian Fit for Mixed Event Pairs
    ...
    // The segmentation error is somewhere after here
    ...
    c14->Update();
    c14->SaveAs("canvas14.png");
    std::cout << "canvas 14 saved" << std::endl;
