...
void test2() {
    ...
    std::cout << "Integral of the bins in h1_diff_l from " << peakStart << " to " << peakEnd << " GeV/c^2: " << bin_integral_l << std::endl;
    ...
    std::cout << "Integral of the bins in h1_diff_lbar from " << peakStart << " to " << peakEnd << " GeV/c^2: " << bin_integral_lbar << std::endl;
