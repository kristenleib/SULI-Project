...
void LL_oneplot(){
    ...
    // TH2F *h2_lambda_us_lambda_us = new TH2F("h2_lambda_us_lambda_us", "Unlike Sign Lambda - Unlike Sign Lambda (Includes Background)", 100, 1.1, 1.14, 100, 1.1, 1.14);
    // TH2F *h2_lambda_us_lambda_ls = new TH2F("h2_lambda_us_lambda_ls", "Unlike Sign Lambda - Like Sign Lambda (Background)", 100, 1.0, 1.4, 100, 1.0, 1.4);
    // TH2F *h2_lambda_us_lambda_bar_us = new TH2F("h2_lambda_us_lambda_bar_us", "Unlike Sign Lambda - Unlike Sign Lambda Bar (Includes Background)", 100, 1.0, 1.4, 100, 1.0, 1.4);
    // TH2F *h2_lambda_us_lambda_bar_ls = new TH2F("h2_lambda_us_lambda_bar_ls", "Unlike Sign Lambda - Like Sign Lambda Bar (Background)", 100, 1.0, 1.4, 100, 1.0, 1.4);
    // TH2F *h2_lambda_bar_us_lambda_bar_us = new TH2F("h2_lambda_bar_us_lambda_bar_us", "Unlike Sign Lambda Bar - Unlike Sign Lambda Bar (Includes Background)", 100, 1.0, 1.4, 100, 1.0, 1.4);
    // TH2F *h2_lambda_bar_us_lambda_bar_ls = new TH2F("h2_lambda_bar_us_lambda_ls", "Unlike Sign Lambda Bar - Like Sign Lambda Bar (Background)", 100, 1.0, 1.4, 100, 1.0, 1.4);

    // The six histograms will go here
    TH2F *h2_lambda_us_lambda_us = new TH2F("h2_lambda_us_lambda_us", "Unlike Sign Lambda - Unlike Sign Lambda (Includes Background)", 100, 1.1, 1.14, 100, 1.1, 1.14);
    TH2F *h2_lambda_us_lambda_ls = new TH2F("h2_lambda_us_lambda_ls", "Unlike Sign Lambda - Like Sign Lambda (Background)", 100, 1.1, 1.14, 100, 1.1, 1.14);
    TH2F *h2_lambda_us_lambda_bar_us = new TH2F("h2_lambda_us_lambda_bar_us", "Unlike Sign Lambda - Unlike Sign Lambda Bar (Includes Background)", 100, 1.1, 1.14, 100, 1.1, 1.14);
    TH2F *h2_lambda_us_lambda_bar_ls = new TH2F("h2_lambda_us_lambda_bar_ls", "Unlike Sign Lambda - Like Sign Lambda Bar (Background)", 100, 1.1, 1.14, 100, 1.1, 1.14);
    TH2F *h2_lambda_bar_us_lambda_bar_us = new TH2F("h2_lambda_bar_us_lambda_bar_us", "Unlike Sign Lambda Bar - Unlike Sign Lambda Bar (Includes Background)", 100, 1.1, 1.14, 100, 1.1, 1.14);
    TH2F *h2_lambda_bar_us_lambda_bar_ls = new TH2F("h2_lambda_bar_us_lambda_ls", "Unlike Sign Lambda Bar - Like Sign Lambda Bar (Background)", 100, 1.1, 1.14, 100, 1.1, 1.14);
    ...
    // Define and fit a 2D Gaussian function
    TF2 *gaus2D_LL = new TF2("gaus2D_LL", "gaus", 1.1, 1.14, 0, 0.2);
    h2_LL_Signal->Fit(gaus2D_LL, "R");
    gaus2D_LL->SetParameters(1.0, 1.115, 0.01, 1.0, 0.1, 0.02);
    gaus2D_LL->Draw("same");

    c1->cd(2);
    h2_LLBar_Signal->Draw("COLZ");
    ...
    // The 3D histograms of the plots
    c2->cd(1);
