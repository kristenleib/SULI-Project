...
void lpair_check5(){
    ...
    TH2F *h2_lambda_bar_us_lambda_bar_ls = new TH2F("h2_lambda_bar_us_lambda_bar_ls", "Unlike Sign Lambda Bar - Like Sign Lambda Bar (cd6)", 100, 1.0, 1.4, 100, 1.0, 1.4);
    ...
    c1->cd(1);
    h2_lambda_us_lambda_us->Draw("COLZ");

    c1->cd(2);
    h2_lambda_us_lambda_bar_us->Draw("COLZ");

    c1->cd(3);
    h2_lambda_bar_us_lambda_bar_us->Draw("COLZ");

    c1->cd(4);
    h2_lambda_us_lambda_ls->Draw("COLZ");

    c1->cd(5);
    h2_lambda_us_lambda_bar_ls->Draw("COLZ");

    c1->cd(6);
    h2_lambda_bar_us_lambda_bar_ls->Draw("COLZ");
    ...
    c2->cd(4);
    h2_lambda_us_lambda_ls->Draw("SURF2");

    c2->cd(5);
    h2_lambda_us_lambda_bar_ls->Draw("SURF2");

    c2->cd(6);
    h2_lambda_bar_us_lambda_bar_ls->Draw("SURF2");
