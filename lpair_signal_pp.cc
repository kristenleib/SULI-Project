...
void lpair_signal_pp(){
    ...
    std::unique_ptr<TCanvas> c5(new TCanvas("c5", "Angular Distributions of Signal with Fit and Background", 1800, 900));
    c5->Divide(3, 1);

    // Lambda - Lambda Calculations
    TH2F *h2_LL_Signal = new TH2F(*h2_lambda_us_lambda_us);
    h2_LL_Signal->Add(h2_lambda_us_lambda_ls, -1.0);

    // Canvas 1: Lambda - Lambda Signal and Gaussian Fit
    double minX = 1.11;
    double maxX = 1.12;
    double minY = 1.11;
    double maxY = 1.12;
    ...
    // Canvas 2: X and Y projections of the Lambda - Lambda Candidates and the Fitting
    c2->cd(1);
    ...
    TH1D *h_cos_theta_starLL = (TH1D*)h_cos_theta_star->Clone("h_cos_theta_starLL");
    ...
    // Canvas 3: Values within the ±3 sigma range of the gaussian fit
    double minX_2 = 1.11;
    double maxX_2 = 1.12;
    double minY_2 = 1.11;
    double maxY_2 = 1.12;
    ...
    // Canvas 4: Angular Correlation of Us-Us and Us-Ls Pairs
    ...
    // Canvas 5: Angular Correlation of Signal with Fitting and Background
    c5->cd(1);
    ...
    // Canvas 2: X and Y projections of the Lambda - Lambda Bar Candidates and the Fitting
    c2->cd(2);
    ...
    // Canvas 3: Lambda - Lambda Bar Values within the ±3 sigma range of the gaussian fit
    c3->cd(2);
    ...
    // Canvas 5: Agular Correlation of Signal with Fit and Background
    c5->cd(2);
    ...
    // Canvas 2: X and Y projections of the Lambda Bar - Lambda Bar Candidates and their Fitting
    c2->cd(3);
    ...
    // Canvas 3: Lambda Bar - Lambda Bar Values within the ±3 sigma range of the gaussian fit
    c3->cd(3);
    ...
    // Canvas 5: Angular Correlation of Signal with Fit and Background
    c5->cd(3);
